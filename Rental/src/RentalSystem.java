...
public class RentalSystem {
    ...
    public boolean rentVehicle(Vehicle vehicle, Customer customer, LocalDate date, double amount) { // Part 2 Question 2
    ...
    public boolean returnVehicle(Vehicle vehicle, Customer customer, LocalDate date, double extraFees) { // Part 2 Question 2
